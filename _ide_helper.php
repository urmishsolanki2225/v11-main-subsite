 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Request::isRobot();
        }
                    /**
        ...
        {
                        return \Illuminate\Http\Request::isHuman();
        }
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getChallenge($challenge, $ip, $version)
        {
                        /** @var \DarkGhostHunter\Captchavel\Captchavel $instance */
                        return $instance->getChallenge($challenge, $ip, $version);
        }
                    /**
         ...
         * @static 
         */ 
        public static function fakeScore($score)
        {
                        /** @var \DarkGhostHunter\Captchavel\CaptchavelFake $instance */
                        $instance->fakeScore($score);
        }
                    /**
         ...
         * @static 
         */ 
        public static function fakeRobots()
        {
                        /** @var \DarkGhostHunter\Captchavel\CaptchavelFake $instance */
                        $instance->fakeRobots();
        }
         ...
         * @static 
         */ 
        public static function fakeHumans()
        {
                        /** @var \DarkGhostHunter\Captchavel\CaptchavelFake $instance */
                        $instance->fakeHumans();
        }
...
namespace  { 
            ...
            class Captchavel extends \DarkGhostHunter\Captchavel\Facades\Captchavel {}
