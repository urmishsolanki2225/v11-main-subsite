...
return [
    ...
    */
    ...
    "searchableAttributes" => [
        ...
        "content",
        "collections",
        "unordered(authors.title)",
        "unordered(countries.title)",
    ],
    ...
    */
    ...
    |
    */
    "replicas" => ["item_contents_publish_desc"],
    "indexLanguages" => ["en", "fr", "es"],
];
