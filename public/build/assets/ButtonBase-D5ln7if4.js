...
`),v.rippleVisible,rt,oe,({theme:e})=>e.transitions.easing.easeInOut,v.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,v.child,v.childLeaving,st,oe,({theme:e})=>e.transitions.easing.easeInOut,v.childPulsate,lt,({theme:e})=>e.transitions.easing.easeInOut),ct=a.forwardRef(function(t,o){const i=ie({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:r={},className:s}=i,c=J(i,ot),[u,p]=a.useState([]),f=a.useRef(0),g=a.useRef(null);a.useEffect(()=>{g.current&&(g.current(),g.current=null)},[u]);const m=a.useRef(!1),b=Oe(),h=a.useRef(null),y=a.useRef(null),V=a.useCallback(d=>{const{pulsate:x,rippleX:M,rippleY:z,rippleSize:j,cb:A}=d;p(S=>[...S,T.jsx(ut,{classes:{ripple:R(r.ripple,v.ripple),rippleVisible:R(r.rippleVisible,v.rippleVisible),ripplePulsate:R(r.ripplePulsate,v.ripplePulsate),child:R(r.child,v.child),childLeaving:R(r.childLeaving,v.childLeaving),childPulsate:R(r.childPulsate,v.childPulsate)},timeout:oe,pulsate:x,rippleX:M,rippleY:z,rippleSize:j},f.current)]),f.current+=1,g.current=A},[r]),_=a.useCallback((d={},x={},M=()=>{})=>{const{pulsate:z=!1,center:j=n||x.pulsate,fakeElement:A=!1}=x;if((d==null?void 0:d.type)==="mousedown"&&m.current){m.current=!1;return}(d==null?void 0:d.type)==="touchstart"&&(m.current=!0);const S=A?null:y.current,B=S?S.getBoundingClientRect():{width:0,height:0,left:0,top:0};let E,I,N;if(j||d===void 0||d.clientX===0&&d.clientY===0||!d.clientX&&!d.touches)E=Math.round(B.width/2),I=Math.round(B.height/2);else{const{clientX:D,clientY:$}=d.touches&&d.touches.length>0?d.touches[0]:d;E=Math.round(D-B.left),I=Math.round($-B.top)}if(j)N=Math.sqrt((2*B.width**2+B.height**2)/3),N%2===0&&(N+=1);else{const D=Math.max(Math.abs((S?S.clientWidth:0)-E),E)*2+2,$=Math.max(Math.abs((S?S.clientHeight:0)-I),I)*2+2;N=Math.sqrt(D**2+$**2)}d!=null&&d.touches?h.current===null&&(h.current=()=>{V({pulsate:z,rippleX:E,rippleY:I,rippleSize:N,cb:M})},b.start(it,()=>{h.current&&(h.current(),h.current=null)})):V({pulsate:z,rippleX:E,rippleY:I,rippleSize:N,cb:M})},[n,V,b]),U=a.useCallback(()=>{_({},{pulsate:!0})},[_]),F=a.useCallback((d,x)=>{if(b.clear(),(d==null?void 0:d.type)==="touchend"&&h.current){h.current(),h.current=null,b.start(0,()=>{F(d,x)});return}h.current=null,p(M=>M.length>0?M.slice(1):M),g.current=x},[b]);return a.useImperativeHandle(o,()=>({pulsate:U,start:_,stop:F}),[U,_,F]),T.jsx(at,P({className:R(v.root,r.root,s),ref:y},c,{children:T.jsx(ae,{component:null,exit:!0,children:u})}))});function pt(e){return Re("MuiButtonBase",e)}const dt=re("MuiButtonBase",["root","disabled","focusVisible"]),ft=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],ht=e=>{const{disabled:t,focusVisible:o,focusVisibleClassName:i,classes:n}=e,s=ve({root:["root",t&&"disabled",o&&"focusVisible"]},pt,n);return o&&i&&(s.root+=` ${i}`),s},mt=q("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${dt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),$t=a.forwardRef(function(t,o){const i=ie({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:r=!1,children:s,className:c,component:u="button",disabled:p=!1,disableRipple:f=!1,disableTouchRipple:g=!1,focusRipple:m=!1,LinkComponent:b="a",onBlur:h,onClick:y,onContextMenu:V,onDragLeave:_,onFocus:U,onFocusVisible:F,onKeyDown:d,onKeyUp:x,onMouseDown:M,onMouseLeave:z,onMouseUp:j,onTouchEnd:A,onTouchMove:S,onTouchStart:B,tabIndex:E=0,TouchRippleProps:I,touchRippleRef:N,type:D}=i,$=J(i,ft),O=a.useRef(null),C=a.useRef(null),xe=fe(C,N),{isFocusVisibleRef:ue,onFocus:Me,onBlur:Se,ref:Ce}=Ke(),[k,W]=a.useState(!1);p&&k&&W(!1),a.useImperativeHandle(n,()=>({focusVisible:()=>{W(!0),O.current.focus()}}),[]);const[Z,Te]=a.useState(!1);a.useEffect(()=>{Te(!0)},[]);const Ee=Z&&!f&&!p;a.useEffect(()=>{k&&m&&!f&&Z&&C.current.pulsate()},[f,m,k,Z]);function w(l,pe,Ue=g){return H(de=>(pe&&pe(de),!Ue&&C.current&&C.current[l](de),!0))}const $e=w("start",M),we=w("stop",V),Ve=w("stop",_),_e=w("stop",j),Be=w("stop",l=>{k&&l.preventDefault(),z&&z(l)}),Ie=w("start",B),Ne=w("stop",A),Pe=w("stop",S),ze=w("stop",l=>{Se(l),ue.current===!1&&W(!1),h&&h(l)},!1),De=H(l=>{O.current||(O.current=l.currentTarget),Me(l),ue.current===!0&&(W(!0),F&&F(l)),U&&U(l)}),ee=()=>{const l=O.current;return u&&u!=="button"&&!(l.tagName==="A"&&l.href)},te=a.useRef(!1),ke=H(l=>{m&&!te.current&&k&&C.current&&l.key===" "&&(te.current=!0,C.current.stop(l,()=>{C.current.start(l)})),l.target===l.currentTarget&&ee()&&l.key===" "&&l.preventDefault(),d&&d(l),l.target===l.currentTarget&&ee()&&l.key==="Enter"&&!p&&(l.preventDefault(),y&&y(l))}),Le=H(l=>{m&&l.key===" "&&C.current&&k&&!l.defaultPrevented&&(te.current=!1,C.current.stop(l,()=>{C.current.pulsate(l)})),x&&x(l),y&&l.target===l.currentTarget&&ee()&&l.key===" "&&!l.defaultPrevented&&y(l)});let X=u;X==="button"&&($.href||$.to)&&(X=b);const K={};X==="button"?(K.type=D===void 0?"button":D,K.disabled=p):(!$.href&&!$.to&&(K.role="button"),p&&(K["aria-disabled"]=p));const Fe=fe(o,Ce,O),ce=P({},i,{centerRipple:r,component:u,disabled:p,disableRipple:f,disableTouchRipple:g,focusRipple:m,tabIndex:E,focusVisible:k}),je=ht(ce);return T.jsxs(mt,P({as:X,className:R(je.root,c),ownerState:ce,onBlur:ze,onClick:y,onContextMenu:we,onFocus:De,onKeyDown:ke,onKeyUp:Le,onMouseDown:$e,onMouseLeave:Be,onMouseUp:_e,onDragLeave:Ve,onTouchEnd:Ne,onTouchMove:Pe,onTouchStart:Ie,ref:Fe,tabIndex:p?-1:E,type:D},K,$,{children:[s,Ee?T.jsx(ct,P({ref:xe,center:r},I)):null]}))});export{$t as B,ae as T,qe as _,Mt as a,Et as c,St as d,Ct as i,Tt as o};
