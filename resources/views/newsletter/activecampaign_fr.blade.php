...
<article class="article_main article_single">
  <header>
	  ...
	  <p>Votre vie privée est importante pour nous. Notre <a href="{{ route('contact.data-protection-policy') }}">politique de protection de données</a> est <a href="{{ route('contact.data-protection-policy') }}">ici</a>.</p>
  </header>
  <main>
